...
import { Factory, Edit, FileText, List } from 'lucide-react';

export default function ManufacturingDashboard() {
  const sections = [
    { id: 'hero', name: 'Hero Section', icon: '🎯', description: 'Main banner with slides' },
    { id: 'capabilities', name: 'Capabilities', icon: '⚡', description: 'Why choose us section' },
    { id: 'products', name: 'Products', icon: '📦', description: 'Product showcase' },
    { id: 'sustainability', name: 'Sustainability', icon: '🌱', description: 'Eco-friendly practices' },
    { id: 'cta', name: 'Call to Action', icon: '📞', description: 'Contact CTA section' }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Manufacturing Page Content</h1>
          <p className="text-gray-600 mt-2">Manage manufacturing sections - edit in multiple languages</p>
        </div>
        <Link
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-4">
          ...
          <p className="text-indigo-100 text-sm">Click edit to manage content in all languages</p>
        </div>
