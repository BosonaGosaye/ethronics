...
const SECTIONS = [
  ...
  { id: 'features', name: 'Features', description: 'Key features and benefits' },
  { id: 'solutions', name: 'Solutions', description: 'Solutions and services' },
  { id: 'gallery', name: 'Gallery', description: 'Image gallery showcase' },
  { id: 'partnerships', name: 'Partnerships', description: 'Partner organizations' },
  { id: 'cta', name: 'Call to Action', description: 'Contact and CTA section' }
];
...
export default function HomeDashboard() {
  ...
  const [stats, setStats] = useState(SECTION_STATS);
    ...
    try {
      ...
      SECTIONS.forEach(section => {
        const allPublished = LANGUAGES.every(lang => 
          contentStatus[lang.code]?.[section.id]?.isPublished
        );
        const anyExists = LANGUAGES.some(lang => 
          contentStatus[lang.code]?.[section.id]
        );
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Manage home page sections with multi-language support</p>
      </div>
        ...
        {SECTIONS.map(section => {
          ...
          return (
            ...
            >
              ...
              <Link
                to={`/home/edit/${section.id}`}
                className="flex items-center justify-center space-x-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-colors w-full"
              >
