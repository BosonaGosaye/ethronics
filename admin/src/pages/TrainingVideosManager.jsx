...
const TrainingVideosManager = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`/training-videos/${id}`);
  ...
  const handleTogglePublish = async (id) => {
    try {
      const response = await axios.put(`/training-videos/${id}/publish`);
      setVideos(videos.map(v => v._id === id ? response.data.data : v));
    } catch (err) {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={() => navigate('/training-videos/new')}
                ...
                <tr key={video._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-right text-sm font-medium">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        onClick={() => navigate(`/training-videos/${video._id}`)}
