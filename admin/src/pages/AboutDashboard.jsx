...
const SECTIONS = [
  { id: 'hero', name: 'Hero Section', description: 'About Us introduction' },
  { id: 'purpose', name: 'Our Purpose', description: 'Mission and vision' },
  { id: 'leaders', name: 'Meet Our Leaders', description: 'Leadership team' },
  { id: 'threeFronts', name: 'Three Fronts', description: 'Our three focus areas' },
  { id: 'journey', name: 'Join Our Journey', description: 'Call to action' }
];
...
export default function AboutDashboard() {
  ...
  const fetchContentStatus = async () => {
    try {
      ...
      for (const lang of LANGUAGES) {
        const response = await axios.get(`/about/admin/${lang.code}`);
        statusMap[lang.code] = {};
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">About Us Page Content</h1>
        <p className="text-gray-600 mt-2">Manage about page content for all languages and sections</p>
      </div>
        ...
        {SECTIONS.map(section => {
          ...
          return (
            ...
            >
              ...
              <Link
                to={`/about/edit/${section.id}`}
                className="flex items-center justify-center space-x-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-colors w-full"
              >
