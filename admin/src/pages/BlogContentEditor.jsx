...
export default function BlogContentEditor() {
  ...
  const fetchAllLanguages = async () => {
    try {
      ...
      for (const lang of LANGUAGES) {
        try {
          const response = await axios.get(`/blog/${lang.code}/${urlSection}`);
  ...
  const togglePublish = async (language) => {
    ...
    try {
      await axios.patch(`/blog/${language}/${urlSection}/publish`);
  ...
  const handleSyncImages = async () => {
    ...
    try {
      const result = await syncImagesToAllLanguages('blog', 'en', urlSection, fields);
      return result;
    } catch (error) {
      throw error;
    }
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <textarea
              ...
              className="w-full h-[600px] font-mono text-sm p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              spellCheck={false}
            />
          </div>
        </div>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        ...
        >
          ...
          <span>Back to Blog Dashboard</span>
        </button>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-lg hover:from-orange-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
