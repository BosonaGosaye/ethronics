export const registerTranslations = {
  ...
  am: {
    ...
    objective: {
      ...
      description: "ሮቦቶችን የሚገነቡበት፣ አስደሳች ፕሮጀክቶችን የሚኮዱበት እና አዳዲስ ጓደኞችን የሚያገኙበት አስደናቂ የክረምት ስልጠና ለመጀመር ዝግጁ ይሁኑ። ጥሩ ነገሮችን ይማሩ እና ለማሳየት የሚወዱትን ነገሮች ይፍጠሩ!",
      points: [
        "ሮቦቶችን ይገንቡ፡ አስደሳች መሳሪያዎች ተጠቅመው የራስዎን ሮቦቶች ይፍጠሩ እና እንዲንቀሳቀሱ ይመልከቱ!",
        "ኮድ ማድረግ ይማሩ፡ ፓይቶን እና አርዱዪኖ ተጠቅመው ሮቦቶችዎ አስደናቂ ነገሮች እንዲያደርጉ ያድርጉ።",
        "አስደናቂ ፕሮጀክቶች ይስሩ፡ ዳሳሾችን ተጠቅመው በራሳቸው የሚንቀሳቀሱ እና የሚያስቡ ፕሮጀክቶችን ይፍጠሩ።",
        "በመፍጠር ይዝናኑ፡ አስደሳች ፈተናዎች ላይ ይሰሩ እና ሀሳቦችዎን ያሳዩ።"
      ]
    },
    highlights: {
      title: "የስልጠና ዋና ነጥቦች",
    ...
    faq: {
      ...
      questions: [
        {
          question: "በስልጠናው ምን እማራለሁ?",
          answer: "ሮቦቶችን መገንባትና መፈጠር፣ በፓይቶን እና አርዱዪኖ መኮድ፣ እና የሚንቀሳቀሱ እና የሚያስቡ አሪፍ ፕሮጀክቶችን መስራት ትማራለህ!"
        },
        {
          question: "ኮዲንግ ወይም ሮቦቲክስ መማር አለብኝ?",
          answer: "አይደለም! ካምፓችን ለጀማሪዎች እና ለተማሪዎች ተስማሚ ነው። የሚያስፈልግህን ሁሉ እንድትማር እንረዳለን።"
        },
        {
          question: "ወደ ስልጠና ምን መውሰድ አለብኝ?",
          answer: "የውሃ ጠርሙስ፣ መክሰስ፣ እና ደስታህን ብቻ አምጣ! ሮቦቶች፣ ኮምፒውተሮች፣ እና መሣሪያዎች ሁሉ እኛ እናቀርባለን።"
        }
      ]
    },
    form: {
    ...
    gallery: {
      ...
      galleryDescription: "የስልጠና ቪዲዎቻችንን ይመልከቱ እና ተማሪዎቻችን የፈጠሩትን አስደናቂ ፕሮጀክቶችን ያስሱ። እነዚህ ፕሮጀክቶች በፕሮግራማችን ውስጥ ያዳበሩትን ችሎታዎች ያሳያሉ።",
  ...
  om: {
    hero: {
      title: "Leenjii Injinariing Robootii fi AI Gannaa",
      description: "Leenjii torban 8 (Adoolessa 2 - Fulbaana 4, 2017/18) kutaa 4-12f qophaa'e keessa makamaa. Robootii ijaaraa, koodii barnoota, fi pirojektoota mi'aawaa waliin gammadaa. Muuxannoon hin barbaachisu—imala STEM keessan jalqabaa!",
      button: "Amma Galmaa'aa",
      image: "/src/assets/training-xgzfTKXW.jpg"
    },
    objective: {
      title: "Gammachuu Robootiksii Argachuu",
      description: "Leenjii gannaa ajaa'ibaa robootii ijaartan, pirojektoota gammachuu koodii gootan, fi hiriyoota haaraa argattan qopheeffamuuf qophaa'aa! Wantoota mi'aawaa baradhaa fi wantoota agarsiisuu jaallattan uumaa!",
      points: [
        "Robootii Ijaaraa: Meeshaalee gammachuu fayyadamuun robootii mataa keessanii uumaa fi akka socho'an ilaalaa!",
        "Koodii Barachuu: Python fi Arduino fayyadamuun robootii keessan wantoota ajaa'ibaa akka hojjetan godhaa.",
        "Pirojektoota Ogeessa Hojjechuu: Sensaroota fayyadamuun pirojektoota ofiin socho'an fi yaadan uumaa.",
        "Uumuudhaan Gammadaa: Qormaata gammachuu irratti hojjedhaatii yaada keessan argisiisaa."
      ]
    },
    highlights: {
      title: "Leenjii Ijoo",
    ...
    faq: {
      title: "Gaaffilee Barbaachisoo",
      questions: [
        {
          question: "Kaampii irratti maal baradha?",
          answer: "Robootota ijaaraa fi koodii Phaayitoonii fi Arduino fayyadamuun hojii ajaa'ibaa hojjechuu baratta!"
        },
        {
          question: "Muuxannoo duraan qabaachuu barbaachisa?",
          answer: "Hin barbaachisu! Kaampiin keenya kan jalqabaa fi kan muuxannoo xiqqoo qabuuf qophaa'e."
        },
        {
          question: "Kaampii irratti maal fiduu qaba?",
          answer: "Qaruuraa bishaanii, midhaan xiqqoo, fi gammachuu keessan qofa fidaa! Meeshaalee hundumaa nuti dhiyeessina."
        }
      ]
    },
    form: {
